...
class _AddGuaranteeCheckScreenState extends State<AddGuaranteeCheckScreen> {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            const Text(
              'Ez a garanciális csekk kizárva van és nem használható:',
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            const Text(
              'A garanciális csekkben talált figyelmeztetések:',
              style: TextStyle(fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 16),
  ...
  Future<void> _saveGuaranteeCheck() async {
    ...
    if (_selectedImage == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Kérjük, készítsen képet a garanciális csekkről')),
      );
      return;
    }
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Garanciális csekk sikeresen mentve')),
        );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Új Garanciális Csekk'),
